const falltree_legend = (_, vis, leafId, branchId) => {
    const node = _;
    ...
    const legendData = [{
            ...
            content: ["The color of leave shows the % of people smiled", "or laughed on the day before the survey"],
            sideRight: true,
            offset_y: 0.5,
            image:`./static/imgs/leaf_color.png`,
    ...
    item.filter(d => d.image)
        ...
        .attr('href',d => d.image)
        .attr('x',d => d.sideRight ? text_gap : -200-text_gap*2)
